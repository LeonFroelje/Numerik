...
const polygonverfahren = (f: math.EvalFunction, y_n: math.MathNumericType,
...
export default function EulerVisCard(){
        ...
        cardContent={
            ...
            <Box alignSelf={"center"}>
                <Controlbuttons started={started} setStarted={setStarted} setNext={() => {
                    ...
                    const nextValue = polygonverfahren(ode, prevValue.y, t_n + increment,
                        increment)
